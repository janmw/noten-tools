    ...
    for i in range(gesamt_seiten):
        ...
        if neue_stimme_erkannt:
            ...
            if manuell_abfragen:
                            ...
                            # --- NEU: Dynamische Bildbetrachter-Erkennung ---
                            # Wir definieren eine Liste der gängigsten Linux-Bildbetrachter.
                            # Das Skript nimmt den ersten, den es auf dem System des Nutzers findet.
                            viewers = ["gwenview", "eog", "feh", "imv", "xdg-open"]
                            viewer_cmd = "xdg-open" # Fallback, falls gar nichts gefunden wird
                            
                            for v in viewers:
                                if shutil.which(v): # Prüft, ob das Programm im System existiert
                                    viewer_cmd = v
                                    break
                            
                            # Öffnet das Bild mit dem erkannten Programm
